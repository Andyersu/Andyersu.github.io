...
$.ajax({
    ...
    data: {
        key: 'CMRBZ-YBORT-RDZXR-VWAUR-FNMGF-BGFVY',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(109.131779,21.464926, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
